...
if __name__ == "__main__":
	...
	sc = SparkContext(master="local[2]", appName="ContadorStreams")
	ssc = StreamingContext(sc, 5) # 2 segundos de intervalo de tempo

	ssc.checkpoint("file:///home/flavio/Disc10/trabalhoFinal/") # tolerancia a falhas
	...
	counts = lines.flatMap(lambda line: line.split(" "))\
			.filter(lambda word: str(word).startswith("A") in word)\
